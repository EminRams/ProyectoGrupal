...
<body class="loading" data-layout-config='{"darkMode":false}'>
  ...
  <!-- START FEATURES 1 -->
  <section class="py-5 bg-light-lighten border-top border-bottom border-light" id="features">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="text-center">
      ...
      <div class="row mt-4">
        <div class="col-lg-4">
          <div class="demo-box text-center">
            <img src="/{{BASE_DIR}}/public/images/layouts/layout-1.png" alt="demo-img"
        ...
        <div class="col-lg-4">
          <div class="demo-box text-center mt-3 mt-lg-0">
            <img src="/{{BASE_DIR}}/public/images/layouts/layout-2.png" alt="demo-img"
              class="img-fluid shadow-sm rounded">
        ...
        <div class="col-lg-4">
          <div class="demo-box text-center mt-3 mt-lg-0">
            <img src="/{{BASE_DIR}}/public/images/layouts/layout-3.png" alt="demo-img"
              class="img-fluid shadow-sm rounded">
      ...
      <div class="row mt-4">
        ...
        <div class="col-lg-4">
          <div class="demo-box text-center">
            <img src="/{{BASE_DIR}}/public/images/layouts/layout-5.png" alt="demo-img"
              class="img-fluid shadow-sm rounded">
        ...
        <div class="col-lg-4">
          <div class="demo-box text-center mt-3 mt-lg-0">
            <img src="/{{BASE_DIR}}/public/images/layouts/layout-6.png" alt="demo-img"
              class="img-fluid shadow-sm rounded">
        ...
        <div class="col-lg-4">
          <div class="demo-box text-center mt-3 mt-lg-0">
            <img src="/{{BASE_DIR}}/public/images/layouts/layout-4.png" alt="demo-img"
              class="img-fluid shadow-sm rounded">
  ...
  <section class="py-5 bg-light-lighten border-top border-bottom border-light" id="contacts">
    <div class="container">
      ...
      <div class="row align-items-center mt-3">
        <div class="col-md-4">
          <p class="text-muted"><span class="fw-bold">Customer Support:</span><br> <span class="d-block mt-1">+1 234 56
              7894</span></p>
          <p class="text-muted mt-4"><span class="fw-bold">Email Address:</span><br> <span
              class="d-block mt-1">info@gmail.com</span></p>
          <p class="text-muted mt-4"><span class="fw-bold">Office Address:</span><br> <span class="d-block mt-1">4461
              Cedar Street Moro, AR 72368</span></p>
          <p class="text-muted mt-4"><span class="fw-bold">Office Time:</span><br> <span class="d-block mt-1">9:00AM To
              6:00PM</span></p>
        </div>
