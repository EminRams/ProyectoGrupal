                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    ...
                    <ul class="navbar-nav ms-auto align-items-center">
                        <li class="nav-item me-0">
                            ...
                            <a href="index.php?page=administrador_index" target="_blank" class="btn btn-sm btn-light btn-rounded d-none d-lg-inline-flex">
                    ...
                    <ul class="navbar-nav ms-auto align-items-center">
                        <li class="nav-item me-0">
                            ...
                            <a href="index.php?page=cliente_index" target="_blank" class="btn btn-sm btn-light btn-rounded d-none d-lg-inline-flex">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="text-md-end mt-3 mt-md-0">
                            <img src="/{{BASE_DIR}}/public/images/startup.svg" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-5 bg-light-lighten border-top border-bottom border-light">
            <div class="container">
                ...
                <div class="row mt-4">
                    <div class="col-lg-4">
                        <div class="demo-box text-center">
                            <img src="/{{BASE_DIR}}/public/images/layouts/layout-1.png" alt="demo-img" class="img-fluid shadow-sm rounded">
                    ...
                    <div class="col-lg-4">
                        <div class="demo-box text-center mt-3 mt-lg-0">
                            <img src="/{{BASE_DIR}}/public/images/layouts/layout-2.png" alt="demo-img" class="img-fluid shadow-sm rounded">
                            <h5 class="mt-3 f-17">Horizontal Layout</h5>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="demo-box text-center mt-3 mt-lg-0">
                            <img src="/{{BASE_DIR}}/public/images/layouts/layout-3.png" alt="demo-img" class="img-fluid shadow-sm rounded">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-4">
                        <div class="demo-box text-center">
                            <img src="/{{BASE_DIR}}/public/images/layouts/layout-5.png" alt="demo-img" class="img-fluid shadow-sm rounded">
                            <h5 class="mt-3 f-17">Light Sidenav Layout</h5>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="demo-box text-center mt-3 mt-lg-0">
                            <img src="/{{BASE_DIR}}/public/images/layouts/layout-6.png" alt="demo-img" class="img-fluid shadow-sm rounded">
                    ...
                    <div class="col-lg-4">
                        <div class="demo-box text-center mt-3 mt-lg-0">
                            <img src="/{{BASE_DIR}}/public/images/layouts/layout-4.png" alt="demo-img" class="img-fluid shadow-sm rounded">
        ...
        <section class="py-5">
            <div class="container">
                ...
                <div class="row mt-2 py-5 align-items-center">
                    <div class="col-lg-5">
                        <img src="/{{BASE_DIR}}/public/images/features-1.svg" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row pb-3 pt-5 align-items-center">
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <img src="/{{BASE_DIR}}/public/images/features-2.svg" class="img-fluid" alt="">
                    </div>
                </div>
