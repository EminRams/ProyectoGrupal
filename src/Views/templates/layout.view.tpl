    ...
    <div class="wrapper">
        ...
        <div class="leftside-menu">
            ...
            <a href="index.html" class="logo text-center logo-light">
                <span class="logo-lg">
                    <img src="/{{BASE_DIR}}/public/images/logo.png" alt="" height="100">
                </span>
                <span class="logo-sm">
                    <img src="/{{BASE_DIR}}/public/images/logo_sm.png" alt="" height="100">
                </span>
            </a>
            ...
            <a href="index.html" class="logo text-center logo-dark">
                <span class="logo-lg">
                    <img src="/{{BASE_DIR}}/public/images/logo-dark.png" alt="" height="100">
                </span>
                <span class="logo-sm">
                    <img src="/{{BASE_DIR}}/public/images/logo_sm_dark.png" alt="" height="100">
                </span>
            </a>
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown"
                                ...
                                <span class="account-user-avatar">
                                    <img src="/{{BASE_DIR}}/public/images/users/avatar-1.jpg" alt="user-image"
                        ...
                        <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex">
                                        <img class="d-flex me-2 rounded-circle"
                                            src="/{{BASE_DIR}}/public/images/users/avatar-2.jpg"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex">
                                        <img class="d-flex me-2 rounded-circle"
                                            src="/{{BASE_DIR}}/public/images/users/avatar-5.jpg"
                                            alt="Generic placeholder image" height="32">
                                        <div class="w-100">
