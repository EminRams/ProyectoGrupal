    ...
    <div class="card-body">
      <div class="row g-2">
        ...
        <div class="mb-3 col-md-3">
          ...
          <input type="number" step="0.01" class="form-control" id="precio" name="precio" value="{{precio}}"
            placeholder="Precio" {{readonly}}>
        </div>
        <!--Existencias-->
        <div class="mb-3 col-md-3">
          <label for="stock" class="form-label">Existencias</label>
          <input type="number" class="form-control" id="stock" name="stock" value="{{stock}}" placeholder="Existencias"
            {{readonly}}>
        </div>
      </div>
      <div class="row">
              ...
              <div class="form-check mb-2 col-lg-3 col-md-4">
                <div class="form-check">
                  <input type="radio" id="talla" name="talla" class="form-check-input" value="S"
                    style="border:1px solid var(--bs-indigo);" {{talla_s}} {{disabled}} />
