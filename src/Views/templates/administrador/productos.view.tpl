                                            ...
                                            <table class="table table-centered w-100 dt-responsive nowrap" id="products-datatable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="/{{BASE_DIR}}/public/images/products/product-1.jpg" alt="contact-img" title="contact-img" class="rounded me-3" height="48">
                                                            <p class="m-0 d-inline-block align-middle font-16">
                                                                <a href="index.php?page=administrador_productosdetalle" class="text-body">Amazing Modern Chair</a>
                                                                <br>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="/{{BASE_DIR}}/public/images/products/product-4.jpg" alt="contact-img" title="contact-img" class="rounded me-3" height="48">
                                                            <p class="m-0 d-inline-block align-middle font-16">
                                                                <a href="index.php?page=administrador_productosdetalle" class="text-body">Biblio Plastic Armchair</a>
                                                                <br>
                                                                <span class="text-warning mdi mdi-star"></span>
                                                                <span class="text-warning mdi mdi-star"></span>
                                                                <span class="text-warning mdi mdi-star"></span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="/{{BASE_DIR}}/public/images/products/product-3.jpg" alt="contact-img" title="contact-img" class="rounded me-3" height="48">
                                                            <p class="m-0 d-inline-block align-middle font-16">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="/{{BASE_DIR}}/public/images/products/product-5.jpg" alt="contact-img" title="contact-img" class="rounded me-3" height="48">
                                                            <p class="m-0 d-inline-block align-middle font-16">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="/{{BASE_DIR}}/public/images/products/product-6.jpg" alt="contact-img" title="contact-img" class="rounded me-3" height="48">
                                                            <p class="m-0 d-inline-block align-middle font-16">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="/{{BASE_DIR}}/public/images/products/product-2.jpg" alt="contact-img" title="contact-img" class="rounded me-3" height="48">
                                                            <p class="m-0 d-inline-block align-middle font-16">
