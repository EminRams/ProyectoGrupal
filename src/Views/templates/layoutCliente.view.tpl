<!DOCTYPE html>
    ...
    <head>
        ...
        <!-- third party css -->
        <link href="/{{BASE_DIR}}/public/css/vendor/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css">
        <!-- third party css end -->
                        ...
                        <div class="container-fluid">
                            ...
                            <a href="" class="topnav-logo">
                                <span class="topnav-logo-lg">
                                    <img src="/{{BASE_DIR}}/public/images/logo-light.png" alt="" height="16">
                                </span>
                            ...
                            <ul class="list-unstyled topbar-menu float-end mb-0">
                                ...
                                <li class="dropdown notification-list topbar-dropdown d-none d-lg-block">
                                    <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" id="topbar-languagedrop" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                        <img src="/{{BASE_DIR}}/public/images/flags/us.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">English</span> <i class="mdi mdi-chevron-down"></i>
                                    </a>
