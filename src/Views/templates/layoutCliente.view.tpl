            ...
            <ul class="list-unstyled topbar-menu float-end mb-0">
              ...
              <li class="dropdown notification-list topbar-dropdown d-none d-lg-block">
                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" id="topbar-languagedrop"
                  ...
                  <img src="/{{BASE_DIR}}/public/images/flags/us.jpg" alt="user-image" class="me-1" height="12"> <span
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu"
                  ...
                  <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="/{{BASE_DIR}}/public/images/flags/germany.jpg" alt="user-image" class="me-1" height="12">
                    <span class="align-middle">German</span>
                  </a>

                  <!-- item-->
                  <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="/{{BASE_DIR}}/public/images/flags/italy.jpg" alt="user-image" class="me-1" height="12">
                    <span class="align-middle">Italian</span>
                  </a>

                  <!-- item-->
                  <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="/{{BASE_DIR}}/public/images/flags/spain.jpg" alt="user-image" class="me-1" height="12">
                    <span class="align-middle">Spanish</span>
                  </a>

                  <!-- item-->
                  <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="/{{BASE_DIR}}/public/images/flags/russia.jpg" alt="user-image" class="me-1" height="12">
                  ...
                  <div style="max-height: 230px;" data-simplebar="">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                      <div class="notify-icon">
                        <img src="/{{BASE_DIR}}/public/images/users/avatar-2.jpg" class="img-fluid rounded-circle"
                          alt="">
                      </div>
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                      <div class="notify-icon">
                        <img src="/{{BASE_DIR}}/public/images/users/avatar-4.jpg" class="img-fluid rounded-circle"
                          alt="">
                      </div>
