...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h1 class="page-title">Pasarela de pagos</h1>
        </div>
    </div>
</div>
<!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" placeholder="(xx) xxx xxxx xxx"
                                                    id="billing-phone">
                                            </div>
                                        </div>
                                    </div> <!-- end row -->
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="customCheck2">Ship to different
                                                        address ?</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-sm-6">
                                            <a href="index.php?page=cliente_carretilla"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="/{{BASE_DIR}}/public/images/products/product-1.jpg"
                                                            alt="contact-img" title="contact-img" class="rounded me-2"
                                                            height="48">
                            ...
                            <div class="col-lg-8">
                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="new-adr-email-address" class="form-label">Email Address
                                                    <span class="text-danger">*</span></label>
                                                <input class="form-control" type="email" placeholder="Enter your email"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="border p-3 rounded mb-3 mb-md-0">
                                                <div class="form-check">
                                                    <input type="radio" id="shippingMethodRadio1" name="shippingOptions"
                                                        class="form-check-input" checked="">
                                                    <label class="form-check-label font-16 fw-bold"
                                                        for="shippingMethodRadio1">Standard Delivery - FREE</label>
                                                </div>
                                                <p class="mb-0 ps-3 pt-1">Estimated 5-7 days shipping (Duties and tax
                                        ...
                                        <div class="col-md-6">
                                            <div class="border p-3 rounded">
                                                <div class="form-check">
                                                    <input type="radio" id="shippingMethodRadio2" name="shippingOptions"
                                                        class="form-check-input">
                                                    <label class="form-check-label font-16 fw-bold"
                                                        for="shippingMethodRadio2">Fast Delivery - $25</label>
                                                </div>
                                                <p class="mb-0 ps-3 pt-1">Estimated 1-2 days shipping (Duties and tax
                                                    may be due upon delivery)</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="border p-3 mb-3 rounded">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                            <img src="/{{BASE_DIR}}/public/images/payments/paypal.png" height="25"
                                                alt="paypal-img">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="border p-3 mb-3 rounded">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                            <img src="/{{BASE_DIR}}/public/images/payments/master.png" height="24"
                                                alt="master-card-img">
                                            <img src="/{{BASE_DIR}}/public/images/payments/discover.png" height="24"
                                                alt="discover-card-img">
                                            <img src="/{{BASE_DIR}}/public/images/payments/visa.png" height="24"
                                                alt="visa-card-img">
                                            <img src="/{{BASE_DIR}}/public/images/payments/stripe.png" height="24"
                                                alt="stripe-card-img">
                                        </div>
                                    </div> <!-- end row -->
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="card-cvv" class="form-control"
                                                    data-toggle="input-mask" data-mask-format="000" placeholder="012">
                                            </div>
                                        </div>
                                    </div> <!-- end row -->
                                </div>
                                ...
                                <div class="border p-3 mb-3 rounded">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                            <img src="/{{BASE_DIR}}/public/images/payments/payoneer.png" height="30"
                                                alt="paypal-img">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="border p-3 mb-3 rounded">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                            <img src="/{{BASE_DIR}}/public/images/payments/cod.png" height="22"
                                                alt="paypal-img">
                                        </div>
                                    </div>
                                </div>
